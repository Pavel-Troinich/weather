import { getCurrentDateTime, сalculateDewPoint } from "./utils.js"
  ...
  widget.insertAdjacentHTML(
    ...
    <div class="widget__other">
      <div class="widget__wind">
        ...
        <p class="widget__wind-text"><img style="transform: rotate(${data.wind.deg}deg); width: 24px;" src="./icon/arrow.svg" alt="wind direction"></p>
      ...
      <div class="widget__pressure">
        ...
        <p class="widget__pressure-value">${(data.main.grnd_level / 1.3332).toFixed(1)}</p>
