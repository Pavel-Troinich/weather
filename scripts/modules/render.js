import { getCurrentDateTime, сalculateDewPoint, getWeatherForecastData, getWindDirection } from "./utils.js"

export const renderWidgetToday = (widget, data) => {
  const { dayOfWeek, dayOfMonth, month, year, hours, minutes } = getCurrentDateTime();
  ...
  widget.insertAdjacentHTML(
    ...
    <div class="widget__today">
      <div class="widget__date-block">
        <p>
          <img class="widget__refresh-img" src="./icon/refresh.svg" alt="refresh-txt" title="Обновить">
          <span class="widget__refresh-txt">Обновлено:</span>
        </p>
      ...
      <div class="widget__wheather">
        <div class="widget__city">
          <p>${data.name}</p>
          <button class="widget__change-city" aria-label="Изменить город" title="Изменить город"></button>
        </div>
    ...
    <div class="widget__other">
      <div class="widget__wind">
        ...
        <p class="widget__wind-text">
          <img class="widget__wind-img" style="transform: rotate(${data.wind.deg}deg);" src="./icon/arrow.svg" alt="wind direction">
      ...
      <div class="widget__humidity">
        ...
        <p class="widget__humidity-text">Т.Р: ${сalculateDewPoint(data.main.temp, data.main.humidity)} °C</p>
      </div>
      <div class="widget__pressure">
        <p class="widget__pressure-title">Давление</p>
        <p class="widget__pressure-value">${(data.main.pressure / 1.3332).toFixed(1)}</p>
...
export const showError = (widget, err) => {
